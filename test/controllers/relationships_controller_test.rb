...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { doner_id: @relationship.doner_id, link_description: @relationship.link_description, target: @relationship.target }
    end
  ...
  test "should update relationship" do
    patch :update, id: @relationship, relationship: { doner_id: @relationship.doner_id, link_description: @relationship.link_description, target: @relationship.target }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
